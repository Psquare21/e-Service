        ...
        <div class="container">
            <div class="row text-center section-title">
                <div class="col-sm-10 col-sm-offset-1">
                    <h2 class="wow fadeInDown" data-wow-duration="700ms" data-wow-delay="300ms">Thank you, for signing up.</h2><br>
                    <h2 class="wow fadeInDown" data-wow-duration="700ms" data-wow-delay="300ms">We will be contacting you shortly.</h2>
