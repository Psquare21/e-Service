...
<html lang="en">
    ...
    <%! String ab,xy;%>
    <%
	ab=(String)request.getAttribute("ab");
    xy=(String)request.getAttribute("xy");

%>
  <% List<sp_verify> list = sp_select.select_sp(xy, ab); %> 
    <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
            <!-- Header -->
...
<h1 style="text-align:center">
   ...
   <tr >
   	...
   	<th><center>&nbsp &nbsp Address &nbsp &nbsp</center></th>
   </tr>
   <%
    	for(sp_verify s1:list){
    		
   %>
   <tr>
   	<td style="padding:10px"><center><%=s1.getId() %></center></td>
   	<td><center><%=s1.getName() %></center></td>
   	<td><center><%=s1.getType() %></center></td>
   	<td><center><%=s1.getAdd() %></center></td>
   	<td>
         	<form name="verify" method="post" action="sp_selector">
				<input type="hidden" name="id" value="<%=s1.getId()%>">
				<input type="submit" name="action" value="Select">
				<input type="submit" name="action" value="Details">
				<input type="submit" name="action" value="Reviews">
			</form>
   	</td>
   	</tr>
   	<% }
