...
<html lang="en">
    ...
    <%! int sp_id; %>
    <% sp_id = Integer.parseInt(request.getParameter("id"));
    list = reviews.get_reviews(sp_id);
...
<div>
        ...
        <div class="container">
            <div class="row text-center section-title">
                <div class="col-sm-10 col-sm-offset-1">
                    <h2 class="wow fadeInDown" data-wow-duration="700ms" data-wow-delay="300ms">Reviews</h2><br>
                    </div>  
                <br>                       
            </div><!--/about-content--> 
     </div> 
 ...
 <% 
 	...
 	for(review re: list){
 		...
 		%>
 		<h3 class="margin-bottom-10" style="margin-left:30px"><%=""+i+".  "+re.getReview() %></h3>
 		<% 
 		i++;
 	}
