...
<html lang="en">
    ...
    <% sp =(sp_verify) request.getAttribute("id1"); 
    %>
     <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
...
<div>
  ...
  <h4><font color="black" style="margin-left:30px"><%=sp.getMail()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Contact Number:</h3>
  <h4><font color="black" style="margin-left:30px"><%=sp.getPhon()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Address: </h3>
  <h4><font color="black" style="margin-left:30px"><%=sp.getAdd()%></font></h4>
