...
<html lang="en">
  ...
  <%
  s1=(signup2) request.getAttribute("a");
  %>
    <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
...
<div>
  ...
  <h3 class="margin-bottom-10" style="margin-left:30px" >Name of Company:</h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getName()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Email: </h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getMail()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Contact Number:</h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getPhon()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Address: </h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getAdd()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Service Type: </h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getType()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Sub-Service type: </h3>
  <h4><font color="black" style="margin-left:30px"><%=s1.getSub_type()%></font></h4>
   <br>
   <form name="form" method="post" action="sp_verify" style="margin-left:30px">
   <input type="text" name="id" id="id" value="<%=s1.getId()%>"hidden>
   <input type="submit" id="verify" name="action" value="Verify">
   &nbsp &nbsp &nbsp &nbsp &nbsp<input type="submit" id="cancel" name="action" value="Cancel">
