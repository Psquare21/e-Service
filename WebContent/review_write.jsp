...
<html lang="en">
    ...
    <% sp =(sp_verify) request.getAttribute("sp"); 
    %>
...
<div>
        ...
        <div class="container">
            <div class="row text-center section-title">
                <div class="col-sm-10 col-sm-offset-1">
                    <h2 class="wow fadeInDown" data-wow-duration="700ms" data-wow-delay="300ms">Review</h2><br>
                    </div>  
                <br>                       
            </div><!--/about-content--> 
     </div> 
 ...
 <h3 class="margin-bottom-10" style="margin-left:30px" >Company Name:</h3>
  ...
  <form name="review_form" method="post" action="review_done" style="margin-left:30px">
  <input type="hidden" id="id" name="id" value="<%=or.getOrder_id() %>"><br>
  <label><h3>Review:</h3></label><br>
  <% Integer bol = (Integer) request.getAttribute("bol");  
     String review=(String) request.getAttribute("review");
      if(bol == 1){
  
  %>
  
  <textarea class="form-control" name="review" id="review" rows="3" readonly><%=review %></textarea><br>
  
  <% } else {
  
	  %>
  <textarea class="form-control" name="review" id="review" rows="3" placeholder="Please give your review." ></textarea><br>
  
  <% } %>
  
  <!--   <input type="textarea" id="review" name="review" rows="50"  class="form-control" placeholder="Please write your review."><br> -->
 <center> <input type="submit" id="done" name="action" value="Done">
  <input type="submit" id="cancel" name="action" value="Cancel"></center>
