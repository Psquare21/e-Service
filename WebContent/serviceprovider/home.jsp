...
<h2 style="text-align:center">Welcome to Service Provider Panel</h2>
...
<form class="cen" name="login" class="form-horizontal" action="../ServiceproviderLogin" method="post">
