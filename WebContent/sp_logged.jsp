...
%>
<% int count = order_book.get_comorder1(s.getId()); %>
            ...
            <div id="pre-header" class="background-gray-lighter">
            		<div class="container no-padding">
            			<div class="row hidden-xs">
            				...
            				<br>	<strong><h2>E-Service</h2></strong>
            				</div>
            				<div class="col-sm-6 text-right padding-vert-5">
            				
            					<form name="form" method="post" action="logout_sp.jsp" style="margin-right:30px">
            					<br><input type="submit" id="but" name="update" value="Logout" class="btn" style="color:black">
...
<div>
   ...
   <form id="form1" method="post" action="orders">
   <input id="id" name="id" value="<%=s.getId() %>" hidden>
  
  </div>
   <h3> <input type="submit" name="action" value="Orders">  &nbsp You have <%=count %> services available</h3>
  </form> <br>
   <br><br>
            <!-- === BEGIN FOOTER === -->
            <div id="base">
