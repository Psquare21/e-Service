                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="logout.jsp">
                                        <span class="fa-th">Logout&nbsp;</span></a>
                                    </li>
...
<form method="post" id="pnm" name="form" action="update2">
<input type="hidden" name="id" value="<%=s.getId()%>">

<label for="exampleInputName2">First Name:</label>
<input type="text" name="name" onblur="checkfname()" placeholder="First Name" value="<%=s.getName() %>" class="form-control" required>
<span id="f1" style="color:red"></span><br>



<label for="exampleInputEmail1">Email:</label>
<input type="email" name="mail"  onblur="validemail()" placeholder="Email" value="<%=s.getMail() %>" class="form-control" required>
<span id="raj1" style="color:red"></span><br>

<label for="exampleInputPassword1">Password:</label>
<input type="password" name="pass"  placeholder="Password" value="<%=s.getPass() %>" class="form-control"required>



<label>Address:</label>
<textarea class="form-control" name="add" rows="3" placeholder="Address" required><%=s.getAdd() %></textarea>

    <label for="">Phone :</label>
    <input type="text" name="phon"  maxlength="10" onblur="checknum()" placeholder="Phone Number" value="<%=s.getPhon()%>" class="form-control"required>
	<span id="n1" style="color:red"></span><br>


    <label>City</label>

    <input type="text" name="city" id="city" placeholder="City Name" value="<%=s.getCity()%>"class="form-control"required>
    
    </select><br>
<center>
    <input  class="btn btn-success" id="but" type="submit" name="action" value="Update">
     <input class="btn btn-success" id="but2" type="submit" name="action" value="Cancel" style="margin-left:20px">
</center>
</form>
</div>
</div>
