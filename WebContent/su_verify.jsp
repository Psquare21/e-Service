...
<html lang="en">
  ...
  <% si=(signup)request.getAttribute("xy"); %>
    <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
            <!-- Header -->
...
<div>
  ...
  <h3 class="margin-bottom-10" style="margin-left:30px" >Name of Person:</h3>
  <h4><font color="black" style="margin-left:30px"><%=si.getName()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px" >User Name:</h3>
  <h4><font color="black" style="margin-left:30px"><%=si.getUid()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Email: </h3>
  <h4><font color="black" style="margin-left:30px"><%=si.getMail()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Contact Number:</h3>
  <h4><font color="black" style="margin-left:30px"><%=si.getPhon()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Address: </h3>
  <h4><font color="black" style="margin-left:30px"><%=si.getAdd()%></font></h4>
  
   <br>
   <form name="form" method="post" action="su_verify" style="margin-left:30px">
   <input type="text" name="id" id="id" value="<%=si.getId()%>"hidden>
