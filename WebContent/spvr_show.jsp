...
%>
  <% List<signup2> list = sp_showdao.getallspvr(); %> 
    <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
            <!-- Header -->
            		...
            		<div class="container no-padding">
            			<div class="row hidden-xs">
            				...
            				<div class="col-sm-6 text-right padding-vert-5">
            					...
            					<input type="submit" id="home" name="action" value="Home" class="btn" style="color:black"></form>
            				</div>
...
<h1 style="text-align:center">
   ...
   <tr>
   	...
   	<td>
         	<form name="verify" method="post" action="spvr_controller">
