...
<li class="active"><a href="repairSP.jsp"><i class="fa fa-wrench"></i>&nbsp;Repair and maintenance</a>
</li>
...
<div class="row">
<div class="col-md-6"><h1 style="margin-top:0px">Repair and maintenance</h1></div>
