...
<html lang="en">
    ...
    <% sp =(sp_verify) request.getAttribute("sp1"); 
     
    %>
    <%! order_temp or =new order_temp(); %>
    <% or =(order_temp) request.getAttribute("or1");
    %>
    <%!signup su =new signup(); %>
    <% su = (signup)session.getAttribute("user"); 
    %>
     <div id="body-bg">
            <!-- Phone/Email -->
            <!-- End Phone/Email -->
...
<div>
  ...
  <h3 class="margin-bottom-10" style="margin-left:30px">Company Name: </h3>
  <h4><font color="black" style="margin-left:30px"><%=sp.getName()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Your Name:</h3>
  <h4><font color="black" style="margin-left:30px"><%=su.getName()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Address of Service: </h3>
  <h4><font color="black" style="margin-left:30px"><%=su.getAdd()%></font></h4>
  <h3 class="margin-bottom-10" style="margin-left:30px">Service Type: </h3>
  <h4><font color="black" style="margin-left:30px"><%=sp.getType()%></font></h4>
   <h3 class="margin-bottom-10" style="margin-left:30px">Comments: </h3>
  <h4><font color="black" style="margin-left:30px"><%=or.getComm()%></font></h4>
 
   <br>
   <form name="form" method="post" action="confirm_order" style="margin-left:30px">
   <input type="hidden" id="or_id" name="or_id" value="<%=or.getOrder_id() %>">
